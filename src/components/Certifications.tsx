...
export default function Certifications() {
  ...
  return (
    <section id="certifications" className="relative bg-slate-50 dark:bg-slate-950 py-24 border-b border-slate-200/80 dark:border-slate-900 transition-colors duration-300">
